            ...
            <div class="col-lg-12 pr-lg-5">
                <div class="row">
                	<c:forEach var="tempApplypost" items="${applyposts}">
                            ...
                            <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
                                <div class="one-third mb-4 mb-md-0">
                                    <div class="job-post-item-header align-items-center">
                                        <span class="subadge">${tempApplypost.recruitment.type}</span>
                                        <h2 class="mr-3 text-black" ><a href="${pageContext.request.contextPath}/post/detailPost?id=${tempApplypost.recruitment.id}">${tempApplypost.recruitment.title}</a></h2>
                                    </div>
                                    <div class="job-post-item-body d-block d-md-flex">
                                        <div class="mr-3"><span class="icon-layers"></span> <a href="${pageContext.request.contextPath}/company/detailCompany?id=${tempApplypost.recruitment.company.id}">${tempApplypost.recruitment.company.companyName}</a></div>
                                        <div><span class="icon-my_location"></span> <span>${tempApplypost.recruitment.address}</span></div>
                                    </div>
                                </div>
                                <input type="hidden" id="idRe${tempApplypost.recruitment.id}" value="${tempApplypost.recruitment.id}">
                                <div class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0">
                                    <div>
                                        <a href="${pageContext.request.contextPath}/user/deleteApplypost?recruitmentID=${tempApplypost.recruitment.id}" class="icon text-center d-flex justify-content-center align-items-center icon mr-2">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal${tempApplypost.recruitment.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Ứng tuyển: <span>${tempApplypost.recruitment.title}</span></h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <input type="file" class="form-control" id="fileUpload${tempApplypost.recruitment.id}" name="file" required>
                                                    <label for="fileUpload" class="col-form-label">Giới thiệu:</label>
                                                    <textarea rows="10" cols="3" class="form-control" id="text${tempApplypost.recruitment.id}" ></textarea>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                                                <button type="button" onclick="apply(${tempApplypost.recruitment.id})" class="btn btn-primary">Nộp</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
